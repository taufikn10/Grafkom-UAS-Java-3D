 ...
 * @author Taufik
 */
public class BumiBulan extends Application{
    ...
    private final Sphere bulan = new Sphere(20);
  ...
  private Node[] prepareLightSource() {
    pointLight.setColor(Color.DARKGREY);
    pointLight.getTransforms().add(new Translate(0, -50, 400));
