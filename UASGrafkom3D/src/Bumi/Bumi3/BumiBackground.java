 ...
 * @author Taufik
 */
public class BumiBackground extends Application{
    ...
    public void start (Stage primaryStage) throws Exception {
        ...
        primaryStage.setTitle("Background Bumi");
    ...
    private ImageView background(){
        Image backImage = new Image(BumiBackground.class.getResourceAsStream("/resources/Background/space2.jpg"));
        ImageView iv = new ImageView(backImage);
        iv.setPreserveRatio(true);
        iv.getTransforms().add(new Translate(-backImage.getWidth()/2, -backImage.getHeight()/2, 800));
        return iv;
    }
