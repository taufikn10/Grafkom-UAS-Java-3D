 ...
 * @author Taufik
 */
public class MarsFinal extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        planet.translateZProperty().bind(slider.valueProperty());
        ...
        primaryStage.getIcons().add(new Image("/resources/Icon/marsIcon.png"));
    ...
    private ImageView background(){
        Image backImage = new Image(MarsFinal.class.getResourceAsStream("/resources/Background/space.jpg"));
